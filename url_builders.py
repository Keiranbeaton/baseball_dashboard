...
def fg_splits_page(start_date, end_date, split):
    ...
    """
    return f"https://www.fangraphs.com/leaders/splits-leaderboards?splitArr={split}8&splitArrPitch=&autoPt=false&splitTeams=false&statType=team&statgroup=1&startDate={start_date}&endDate={end_date}&players=&filter=&groupBy=season&wxTemperature=&wxPressure=&wxAirDensity=&wxElevation=&wxWindSpeed=&position=B&sort=22,1"
